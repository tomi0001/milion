...
class calendar
{
    ...
    public $next_year;
    public $back_year;
    function __construct($month,$action,$day,$year) {
    
            $this->set_date($month,$action,$day,$year);
            $this->how_day_month = $this->check_month($this->month,$this->year);
            $this->back_month = $this->return_back_month($this->month,$this->year);
            $this->next_month = $this->return_next_month($this->month,$this->year);
            $this->text_month = $this->return_month_text($this->month);
            $this->next_year  = $this->return_next_year($this->year);
            $this->back_year  = $this->return_back_year($this->year);
    }
